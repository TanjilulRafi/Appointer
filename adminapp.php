...
<div class="container_r">
    ...
    @include 'config.php';
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<thead class='thead-dark'><tr><th>SL.</th><th>Name</th><th>Phone</th><th>Doctor Name</th>
            <th>Date</th><th>Time</th><th>Update</th><th>Delete</th></tr></thead>";
            echo "<tbody>";
            $i = 1;
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='updateapp.php?id={$row["id"]}' class='btn btn-primary'>Update</a></td>";
                echo "<td>
                        <form method='POST' action='deleteapp.php'>
                            <input type='hidden' name='app_id' value='{$row["id"]}'>
                            <button type='submit' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete Appointment?\")'>Delete</button>
                        </form>
                    </td>";
                echo "</tr>";
                $i++;
