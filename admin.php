...
<div class="container_r">
    ...
    @include 'config.php';
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<thead class='thead-dark'><tr><th>SL.</th><th>Name</th><th>Email</th><th>Update</th><th>Delete</th></tr></thead>";
            echo "<tbody>";
            $i = 1;
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='updateuser.php?id={$row["id"]}' class='btn btn-primary'>Update</a></td>";
                echo "<td>
